...
/* Private defines -----------------------------------------------------------*/
#define Motor4_In2_Pin GPIO_PIN_4
#define Motor4_In2_GPIO_Port GPIOA
#define Motor4_In1_Pin GPIO_PIN_0
#define Motor4_In1_GPIO_Port GPIOB
#define TimeStartOut_Pin GPIO_PIN_10
#define TimeStartOut_GPIO_Port GPIOB
#define TimeStart_Pin GPIO_PIN_8
#define TimeStart_GPIO_Port GPIOA
